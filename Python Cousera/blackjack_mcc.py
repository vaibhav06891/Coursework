...
def draw(canvas):
    ...
    canvas.draw_image(card_back, [35.5, 48], [71 , 96], [65 , 278], [71 , 96])
#    card = Card("S", "A")
 #   card.draw(canvas, [300, 300])
    canvas.draw_text("Blackjack", [25,90], 35, "Red")
    canvas.draw_text("Score = "+str(score), [220,140], 24, "Black")
    canvas.draw_text(outcome, [220,180], 24, "Black")
    canvas.draw_text("Dealer", [25,180], 24, "Black")
    canvas.draw_text(ins, [220,400], 24, "Black")
    canvas.draw_text("Player", [25,400], 24, "Black")
    
    dealer.draw(canvas, [125, 230])
    player.draw(canvas, [125, 450])
    
    


# initialization frame
frame = simplegui.create_frame("Blackjack", 400, 640)
